...
public class AddressUtil {
    ...
    public static String getCityInfo(String ip) {
        try {
            // 获取当前记录地址位置的文件
            String dbPath = Objects.requireNonNull(AddressUtil.class.getResource("/xdb/ip2region.xdb")).getPath();
            ...
            if (!file.exists()) {
                ...
                FileUtils.copyInputStreamToFile(Objects.requireNonNull(AddressUtil.class.getClassLoader().getResourceAsStream("classpath:xdb/xdb.xdb")), file);
            }
            //创建查询对象
