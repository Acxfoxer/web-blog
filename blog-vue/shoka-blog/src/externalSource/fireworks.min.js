	...
	if (("false" !== n.getAttribute("mobile") || !/Android|webOS|iPhone|iPod|iPad|BlackBerry/i.test(navigator.userAgent)) && n) {
		!(function() {
			(n = this), (e = function() {
				...
				function D(n) {
					if (u.dom(n)) {
						for (var e, t = n.style.transform || "", r = /(\w+)\(([^)]*)\)/g, a = new Map();
							(e = r.exec(t));) a.set(e[1], e[2]);
						return a
					}
				}
		...
		var e = n.getContext("2d"),
			...
			r = 0,
			a = 0,
			i = ["rgba(255,182,185,.9)", "rgba(250,227,217,.9)", "rgba(187,222,214,.9)", "rgba(138,198,209,.9)", ],
			o = (function(n, e, t) {
				let r;
				return function() {
					const a = this,
		...
		document.addEventListener("mousedown", function(i) {
			"sidebar" !== i.target.id && "toggle-sidebar" !== i.target.id && "A" !== i.target.nodeName && "IMG" !== i.target.nodeName && (u.play(), (function(e) {
				...
				for (var a = (function(n, t) {
					var r = {};
					return ((r.x = n), (r.y = t), (r.color = "#FFF"), (r.radius = 0.1), (r.alpha = 0.5), (r.lineWidth = 6), (r.draw = function() {
