! function(t, e) {
	...
	return function(t) {
				...
				E = function() {
					...
					return e.hasClass = function(t) {
						...
						for (var r in this.italic > 0 && ((e = document.createElement("span"))
							...
							.className = T(this.classes)), this.style) this.style.hasOwnProperty(r) && ((e = e || document.createElement("span"))
			...
			var St = kt,
				...
				Tt = function(t, e) {
					var r;
					if (t.unit in Mt) r = Mt[t.unit] / e.fontMetrics()
				...
				Dt = {
					...
					mathsym: function(t, e, r, a) {
						return void 0 === a && (a = []), "boldsymbol" === r.font && Ct(t, "Main-Bold", e)
							.metrics ? qt(t, "Main-Bold", e, r, a.concat(["mathbf"])) : "\\" === t || "main" === j[e][t].font ? qt(t, "Main-Regular", e, r, a) : qt(t, "AMS-Regular", e, r, a.concat(["amsrm"]))
					},
					makeSpan: Rt,
					makeSvgSpan: Ot,
					...
					makeOrd: function(t, e, r) {
						...
						if (l) {
							...
							if (Ct(i, d, n)
								.metrics) return qt(i, d, n, e, s.concat(f));
			...
			function de(t, e) {
				...
				o.length > 0 && i.push(pe(o, e)), r && ((a = pe(se(r, e, !0)))
					.classes = ["tag"], i.push(a));
			...
			var Ae = function(t) {
				...
				Ee = function(t, e) {
					...
					i ? (r = (a = Ft(i.base, "accent"))
							.base, i.base = r, n = function(t) {
								if (t instanceof N) return t;
								throw new Error("Expected span<HtmlDomNode> but got " + String(t) + ".")
							}(ue(i, e)), i.base = a) : r = (a = Ft(t, "accent"))
						.base;
					var o = ue(r, e.havingCrampedStyle()),
						s = 0;
					if (a.isShifty && c.isCharacterBox(r)) {
						var h = c.getBaseElem(r);
						s = D(ue(h, e.havingCrampedStyle()))
							.skew
					}
					var l, m = Math.min(o.height, e.fontMetrics()
						.xHeight);
					if (a.isStretchy) l = Oe(a, e), l = Dt.makeVList({
						...
						"\\vec" === a.label ? (u = Dt.staticSvg("vec", e), p = Dt.svgData.vec[1]) : ((u = D(u = Dt.makeOrd({
							...
							.italic = 0, p = u.width), l = Dt.makeSpan(["accent-body"], [u]);
			...
			Qt({
				...
				htmlBuilder: function(t, e) {
					...
					i.classes.push("x-arrow-pad"), t.below && (n = e.havingStyle(a.sub()), (r = Dt.wrapFragment(ue(t.below, n, e), e))
				...
				handler: function(t, e) {
					for (var r = t.parser, a = Ft(e[0], "ordgroup")
						.body, n = "", i = 0; i < a.length; i++) {
						n += Ft(a[i], "textord")
							.text
					}
					var s = parseInt(n);
			...
			var Ve = function(t, e, r) {
				...
				ar = function(t, e, r, a) {
					for (var n = Math.min(2, 3 - a.style.size); n < r.length && "stack" !== r[n].type; n++) {
						var i = Ve(t, rr(r[n]), "math"),
							o = i.height + i.depth;
						if ("small" === r[n].type && (o *= a.havingBaseStyle(r[n].style)
							.sizeMultiplier), o > e) return r[n]
					}
					return r[r.length - 1]
				},
				...
				ir = function(t, e) {
					var r, a, n = e.havingBaseSizing(),
						...
						l = 0,
						m = 0;
					return "small" === i.type ? (t < 1 ? o = 1 : t < 1.4 && (o = .7), l = (1 + s) / o, (r = je("sqrtMain", h = (1 + s + .08) / o, m = 1e3 + 1e3 * s + 80, s, e))
						.style.minWidth = "0.853em", a = .833 / o) : "large" === i.type ? (m = 1080 * Je[i.size], l = (Je[i.size] + s) / o, h = (Je[i.size] + s + .08) / o, (r = je("sqrtSize" + i.size, h, m, s, e))
						.style.minWidth = "1.02em", a = 1 / o) : (h = t + s + .08, l = t + s, m = Math.floor(1e3 * t + s) + 80, (r = je("sqrtTall", h, m, s, e))
						.style.minWidth = "0.742em", a = 1.056), r.height = l, r.style.height = h + "em", {
						span: r,
						advanceWidth: a,
			...
			var pr = function(t, e) {
					...
					if ("sout" === i)(r = Dt.makeSpan(["stretchy", "sout"]))
						.height = e.fontMetrics()
						.defaultRuleThickness / o, s = -.5 * e.fontMetrics()
						.xHeight;
					else {
						/cancel/.test(i) ? h || n.classes.push("cancel-pad") : n.classes.push("boxpad");
						var l = 0,
							m = 0;
						/box/.test(i) ? (m = Math.max(e.fontMetrics()
								.fboxrule, e.minRuleThickness), l = e.fontMetrics()
							.fboxsep + ("colorbox" === i ? 0 : m)) : l = h ? .2 : 0, r = Ie(n, i, l, e), /fbox|boxed|fcolorbox/.test(i) && (r.style.borderStyle = "solid", r.style.borderWidth = m + "em"), s = n.depth + l, t.backgroundColor && (r.style.backgroundColor = t.backgroundColor, t.borderColor && (r.style.borderColor = t.borderColor))
					}
			...
			var yr = function(t, e) {
					...
					for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
						for (var O = I[q] || {}, E = !0;
							"separator" === O.type;) {
							if (E || ((C = Dt.makeSpan(["arraycolsep"], []))
								.style.width = e.fontMetrics()
								.doubleRuleSep + "em", R.push(C)), "|" !== O.separator && ":" !== O.separator) throw new o("Invalid separator type: " + O.separator);
						...
						if (!(a >= s)) {
							var P = void 0;
							(a > 0 || t.hskipBeforeAndAfter) && 0 !== (P = c.deflt(O.pregap, p)) && ((C = Dt.makeSpan(["arraycolsep"], []))
								.style.width = P + "em", R.push(C));
							var D = [];
							for (r = 0; r < n; ++r) {
								var F = h[r],
									V = F[a];
							...
							D = Dt.makeVList({
								positionType: "individualShift",
								children: D
							}, e), D = Dt.makeSpan(["col-align-" + (O.align || "c")], [D]), R.push(D), (a < s - 1 || t.hskipBeforeAndAfter) && 0 !== (P = c.deflt(O.postgap, p)) && ((C = Dt.makeSpan(["arraycolsep"], []))
								.style.width = P + "em", R.push(C))
						}
					}
			...
			gr({
				...
				handler: function(t, e) {
					var r = {
						cols: (Yt(e[0]) ? [e[0]] : Ft(e[0], "ordgroup")
								.body)
							.map(function(t) {
								var e = Gt(t)
									.text;
				...
				handler: function(t, e) {
					var r = (Yt(e[0]) ? [e[0]] : Ft(e[0], "ordgroup")
							.body)
						.map(function(t) {
							var e = Gt(t)
								.text;
					...
					if ((a = vr(t.parser, a, "script"))
						.body[0].length > 1) throw new o("{subarray} can contain only one column");
					return a
				},
				htmlBuilder: yr,
				mathmlBuilder: kr
			...
			Qt({
				...
				handler: function(t, e) {
					...
					for (var i = "", s = 0; s < n.body.length; ++s) i += Ft(n.body[s], "textord")
						.text;
					if ("\\begin" === a) {
			...
			var Ir = function(t, e) {
				...
				Rr = function(t, e) {
					...
					if (t.hasBarLine ? (t.barSize ? (m = Tt(t.barSize, e), l = Dt.makeLineSpan("frac-line", e, m)) : l = Dt.makeLineSpan("frac-line", e), m = l.height, c = l.height) : (l = null, m = 0, c = e.fontMetrics()
					...
					return r = e.havingStyle(a), f.height *= r.sizeMultiplier / e.sizeMultiplier, f.depth *= r.sizeMultiplier / e.sizeMultiplier, g = a.size === w.DISPLAY.size ? e.fontMetrics()
						...
						.delim2, x = null == t.leftDelim ? ce(e, ["mopen"]) : sr(t.leftDelim, g, !0, e.havingStyle(a), t.mode, ["mopen"]), v = t.continued ? Dt.makeSpan([]) : null == t.rightDelim ? ce(e, ["mclose"]) : sr(t.rightDelim, g, !0, e.havingStyle(a), t.mode, ["mclose"]), Dt.makeSpan(["mord"].concat(r.sizingClasses(e)), [x, Dt.makeSpan(["mfrac"], [f]), v], e)
				},
				Or = function(t, e) {
			...
			var Hr = function(t, e) {
				...
				if (a.isOver ? (o = Dt.makeVList({
					...
					.children[0].children[0].children[1].classes.push("svg-align") : (o = Dt.makeVList({
						positionType: "bottom",
			...
			Qt({
				...
				handler: function(t, e, r) {
					var a = t.parser,
						...
						h = "";
					if (r[0])
						for (var l = Ft(r[0], "raw")
							.string.split(","), m = 0; m < l.length; m++) {
							var c = l[m].split("=");
							if (2 === c.length) {
								var u = c[1].trim();
								switch (c[0].trim()) {
					...
					return "" === h && (h = (h = (h = p)
							.replace(/^.*[\\\/]/, ""))
						.substring(0, h.lastIndexOf("."))), a.settings.isTrusted({
				...
				mathmlBuilder: function(t, e) {
					...
					var a = Tt(t.height, e),
						n = 0;
					if (t.totalheight.number > 0 && (n = (n = Tt(t.totalheight, e) - a)
			...
			var Fr = function(t, e, r, a, n, i, o) {
					...
					if (h && s) {
						var u = a.fontMetrics()
							.bigOpSpacing5 + s.elem.height + s.elem.depth + s.kern + t.depth + o;
						l = Dt.makeVList({
							positionType: "bottom",
							positionData: u,
							children: [{
				...
				Ur = function(t, e) {
					...
					if (h.size === w.DISPLAY.size && n.symbol && !c.contains(Vr, n.name) && (l = !0), n.symbol) {
						...
						var f = se(n.body, e, !0);
						1 === f.length && f[0] instanceof E ? (s = f[0])
							.classes[0] = "mop" : s = Dt.makeSpan(["mop"], Dt.tryCombineChars(f), e)
					} else {
					...
					var v = 0,
						b = 0;
					return (s instanceof E || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (v = (s.height - s.depth) / 2 - e.fontMetrics()
						.axisHeight, b = s.italic), i ? Fr(s, r, a, e, h, b, v) : (v && (s.style.position = "relative", s.style.top = v + "em"), s)
				},
				Gr = function(t, e) {
					var r;
			...
			var Xr = function(t, e) {
				...
				if (s ? (r = s.sup, a = s.sub, n = Ft(s.base, "operatorname"), o = !0) : n = Ft(t, "operatorname"), n.body.length > 0) {
					for (var h = n.body.map(function(t) {
						...
						var c = l[m];
						c instanceof E && (c.text = c.text.replace(/\u2212/, "-")
							.replace(/\u2217/, "*"))
					}
				...
				mathmlBuilder: function(t, e) {
					for (var r = ke(t.body, e.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
						...
						if (i instanceof ve.SpaceNode);
							...
							case "mo":
								var o = i.children[0];
								1 === i.children.length && o instanceof ve.TextNode ? o.text = o.text.replace(/\u2212/, "-")
									.replace(/\u2217/, "*") : a = !1;
								break;
							default:
								a = !1
			...
			te({
				...
				htmlBuilder: function(t, e) {
					...
					if (s) {
						...
						a = ue(s, f, e), d || (u = l.height - f.fontMetrics()
							.supDrop * f.sizeMultiplier / e.sizeMultiplier)
					}
					if (h) {
						var g = e.havingStyle(e.style.sub());
						n = ue(h, g, e), d || (p = l.depth + g.fontMetrics()
			...
			var fa = function(t, e) {
				...
				for (r = t.consumeArgs(1)[0]; 1 === r.length && "#" === r[0].text;) {
					if (1 !== (r = t.consumeArgs(1)[0])
						.length) throw new o('Invalid argument number length "' + r.length + '"');
			...
			var ya = {
				...
				wa = function() {
					...
					return e.feed = function(t) {
						...
						var a = r.tokens;
						if (r.numArgs)
							for (var n = this.consumeArgs(r.numArgs), i = (a = a.slice())
								.length - 1; i >= 0; --i) {
								var s = a[i];
								if ("#" === s.text) {
									...
									if ("#" === (s = a[--i])
										...
										var h;
										(h = a)
										.splice.apply(h, [i, 2].concat(n[+s.text - 1]))
									}
								}
							}
				...
				Ma = function() {
					...
					return e.expect = function(t, e) {
						if (void 0 === e && (e = !0), this.fetch()
							.text !== t) throw new o("Expected '" + t + "', got '" + this.fetch()
							.text + "'", this.fetch());
						e && this.consume()
					}, e.consume = function() {
						this.nextToken = null
